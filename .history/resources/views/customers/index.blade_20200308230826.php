        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                            <a href="{{ route('customers.edit',$customer->id)}}" class="btn btn-primary mr-1"><i class="fas fa-user-edit"></i> Edit</a>
                            <form action="{{ route('customers.destroy', $customer->id)}}" method="post">
                                @csrf
                                @method('DELETE')
                                <button class="btn btn-danger mr-1" type="submit"><i class="fas fa-user-slash"></i> Delete</button>
                            </form>
                    </td>
                    <td>
