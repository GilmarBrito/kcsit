                    ...
                    <td>
                        <div class="btn-toolbar" role="toolbar">
                            <div class="btn-group" role="group">
                                <button type="button" class="btn btn-primary rounded" onclick="window.location.href='{{ route('customers.edit',$customer->id)}}'"><i class="fas fa-hand-holding-usd">/customers/1/accounts</i></button>
                                <button type="button" class="btn btn-success rounded"
                                    onclick="window.location.href='{{ route('customers.accounts', ['post' => 1]) }}'>
