                    ...
                    <td>
                        <div class="btn-toolbar" role="toolbar">
                            <div class="btn-group" role="group">
                                <button type="button" class="btn btn-primary rounded" onclick="window.location.href='{{ route('account.show',['id' => $customer->id])}}'"><i class="fas fa-hand-holding-usd"></i></button>
