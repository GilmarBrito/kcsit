        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-toolbar" role="toolbar">
                            <div class="btn-group btn-group mr-1" role="group">
                                <a href="#" class="btn btn-outline-success rounded"><i class="fas fa-dollar-sign"></i> <i class="fas fa-arrow-circle-up"></i> Deposit</a>
                                <a href="#" class="btn btn-outline-danger rounded"><i class="fas fa-dollar-sign"></i> <i class="fas fa-arrow-circle-down"></i> Withdraw</a>
                            </div>
                        </div>
                    </td>
                </tr>
