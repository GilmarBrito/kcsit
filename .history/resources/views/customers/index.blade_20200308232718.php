                    ...
                    <td>
                        <div class="btn-toolbar" role="toolbar">
                            <div class="btn-group btn-group-sm" role="group">
                                <a href="#" class="btn btn-outline-success rounded"><i class="fas fa-arrow-circle-up"></i></a>
                                <a href="#" class="btn btn-outline-danger rounded"><i class="fas fa-arrow-circle-down"></i></a>
                            </div>
                        </div>
                    </td>
                </tr>
