                    ...
                    <td>
                        <div class="btn-toolbar" role="toolbar">
                            <div class="btn-group btn-group" role="group">
                                <a href="#" class="btn btn-outline-success rounded mr-1"><i class="fas fa-dollar-sign"></i> <i class="fas fa-arrow-circle-up"></i> Deposit</a>
                                <a href="#" class="btn btn-outline-danger rounded mr-1"><i class="fas fa-dollar-sign"></i> <i class="fas fa-arrow-circle-down"></i> Withdraw</a>
                            </div>
                        </div>
                    </td>
                </tr>
