        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" class="btn btn-success btn-block"><i class="fas fa-arrow-circle-up"></i> Deposit Money</a>
                    </td>
                    <td>
                        <a href="#" class="btn btn-warning btn-block"><i class="fas fa-arrow-circle-down"></i> Withdraw Money</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
