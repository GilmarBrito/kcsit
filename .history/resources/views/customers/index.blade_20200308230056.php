                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group btn-group-sm" role="group">
                            <a href="#" class="btn btn-outline-success mr-3"><i class="fas fa-arrow-circle-up"></i> Deposit Money</a>
                            <a href="#" class="btn btn-outline-danger mr-3"><i class="fas fa-arrow-circle-down"></i> Withdraw Money</a>
                        </div>
                    </td>
                </tr>
                @endforeach
